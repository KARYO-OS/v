...
export default function DashboardLayout({ children, title }: DashboardLayoutProps) {
  ...
  const mainPadding = displayDensity === 'compact'
    ? 'px-4 py-4 pb-24 sm:px-5 lg:px-6 lg:py-6 lg:pb-8'
    : 'px-5 py-5 pb-24 sm:px-6 lg:px-8 lg:py-7 lg:pb-8';
  ...
  return (
    <div className="desktop-shell flex h-screen overflow-hidden bg-military-dark" data-density={displayDensity}>
      ...
      <div className="relative flex-1 flex flex-col overflow-hidden">
        ...
        <main className={`relative flex-1 overflow-y-auto ${mainPadding}`}>
