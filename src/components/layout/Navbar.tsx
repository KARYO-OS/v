    ...
    <header className="sticky top-0 z-20 border-b border-surface/70 bg-bg-card/88 px-4 backdrop-blur-xl sm:px-5 lg:px-8" data-print-hide>
      ...
      <div className="flex items-center gap-2 sm:gap-2.5">
        ...
        <div className="group relative">
          <button
            className="flex items-center gap-2 rounded-xl border border-surface bg-slate-50 px-2 py-1.5 text-left dark:bg-surface/40"
          ...
          <div className="pointer-events-none absolute right-0 top-[calc(100%+6px)] w-44 rounded-xl border border-surface bg-bg-card p-2 opacity-0 shadow-lg transition-opacity group-hover:pointer-events-auto group-hover:opacity-100">
