...
const NAV_ITEMS: Record<Role, NavItem[]> = {
  admin: [
    ...
    { path: ROLE_ROUTE_PATHS.admin.apel,            label: 'Apel Digital',   icon: 'CalendarDays' },
  ...
  komandan: [
    ...
    { path: ROLE_ROUTE_PATHS.komandan.apel,            label: 'Monitoring Apel',      icon: 'CalendarDays' },
  ...
  prajurit: [
    ...
    { path: ROLE_ROUTE_PATHS.prajurit.apel,       label: 'Apel Digital',      icon: 'CalendarDays' },
